...
public class Outcome  implements java.io.Serializable {
    ...
    public Outcome(Long idOutcome, String detalle, Set<OutcomePorPrograma> outcomePorProgramas, Set<Evaluacion> evaluacions, Set<OutcomePorCurso> outcomePorCursos) {
       this.idOutcome = idOutcome;
       this.detalle = detalle;
